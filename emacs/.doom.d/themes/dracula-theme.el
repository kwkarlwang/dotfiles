;;; my-dracula-theme.el - based on https://draculatheme.com/ -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup dracula-theme nil
  "Options for the `doom-dracula' theme."
  :group 'doom-themes)

(defcustom dracula-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dracula-theme
  :type 'boolean)

(defcustom dracula-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dracula-theme
  :type 'boolean)

(defcustom dracula-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'dracula-theme
  :type 'boolean)

(defcustom dracula-comment-bg dracula-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'dracula-theme
  :type 'boolean)

(defcustom dracula-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme dracula
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#282a36" "undefined" "black"        ))
   (bg-alt     '("#1E2029" "#1c1c1c" "black"        ))
   (base0      '("#1E2029" "#1c1c1c" "black"        ))
   (base1      '("#282a36" "#121212" "brightblack"  ))
   (base2      '("#373844" "#2e2e2e" "brightblack"  ))
   (base3      '("#44475a" "#c6c6c6" "brightblack"  ))
   (base4      '("#565761" "#444444" "brightblack"  ))
   (base5      '("#6272a4" "#a8a8a8" "brightblack"  ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if dracula-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if dracula-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if dracula-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if dracula-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if dracula-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if dracula-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if dracula-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if dracula-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if dracula-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright dracula-brighter-modeline)
   (-modeline-pad
    (when dracula-padded-modeline
      (if (integerp dracula-padded-modeline) dracula-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if dracula-comment-bg (doom-lighten bg 0.05)))
   (mode-line
