local on_attach = function(client, bufnr)
	...
	bufmap("n", "gd", "<cmd>require('telescope.builtin').lsp_definitions()<cr>", NS)
	bufmap("n", "gD", "<cmd>require('telescope.builtin').lsp_references()<cr>", NS)
	bufmap("n", "<leader>lD", "<cmd>require('telescope.builtin').diagnostics()<cr>", NS)
	bufmap("n", "<leader>ld", "<cmd>require('telescope.builtin').diagnostics({bufnr=0})<cr>", NS)
	bufmap("n", "<leader>lS", "<cmd>require('telescope.builtin').lsp_workspace_symbols()<cr>", NS)
	bufmap("n", "<leader>ls", "<cmd>require('telescope.builtin').lsp_document_symbols<cr>", NS)
